...
# Complete domain templates (from provided code)
PROMPTS = {
    "general": (
    ...
    # Conversation template for history-aware responses
    "conversation": (
...
def build_prompt(
    ...
    """
    Build a direct, domain‑aware prompt.
    If conversation_history is provided, use the conversation template.
    Otherwise, use the domain template.
    """
